...
% !TeX encoding = UTF-8
%  请使用xeLaTeX进行编译
\documentclass[oneside,AutoFakeBold=true]{lixinthesis}
...
%% \makesignature % 如需要手写签名，注释掉，默认没有签名
...
\input{chap/latexbasic}
\input{chap/latexadvance}

\backmatter %%%% 后文部分


\bibliography{bibref} %%% 参考文献
\input{chap/appendix}   %%%% 附录，不需要注释掉
\input{chap/thanks}     %%%% 致谢
